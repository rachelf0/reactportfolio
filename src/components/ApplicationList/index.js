  ...
  const [applications] = useState([
    {
      ...
      name: 'Run Buddy',
      category: 'front',
      description: 'Front end sit of a running based company. Technologies used include HTML and CSS.',
    ...
    },
    {
      name: 'Taskinator',
      category: 'front',
      description: 'An app for keeping tasks organized. Technologies used include HTML, CSS and JavaScript.',
    ...
    },
    {
      ...
      category: 'front',
      description: 'An app for planning out your days built with HTML, CSS and JavaScript',
    ...
    },
    {
      ...
      category: 'front',
      description: 'A weather app using weather forecast information built with HTML, CSS, JavaScript, JQuery, and Bootstrap.',
    ...
    },
    {
      ...
      category: 'back',
      description: 'A Node.js app for generating a markdown readme page built with JavaScript and Bootstrap.',
    ...
    },
    {
      ...
      category: 'back',
      description: 'A Node.js build appn to generate an HTML page of team members with team roles and other data built with JavaScript.',
    ...
    },
    {
      name: 'Note Taker',
      category: 'back',
      description: 'A note taking program in which my role was to focus on the back end build built with JavaScript, Node.js and Express.js.',
    ...
    },
    {
      ...
      category: 'full',
      description: 'A website for spontaneous travelers to plan last minute activities, check weather and buy tickets to local events. Technologies include HTML, CSS and JavaScript.',
    ...
    },
    {
      name: 'Budget Tracker',
      category: 'full',
      description: 'A Progressive Web Application built from an already functioning front end app with JavaScript.',
    ...
    },
    {
      name: 'The Speakeasy',
      category: 'full',
      description: 'A MERN stack application built for those seeking to try and share exquisite cocktail recipes. Technologies used include JavaScript and Bootstrap.',
